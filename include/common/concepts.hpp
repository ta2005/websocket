...
// A C++20 Concept defining the unified interface for both Sync and Async
// clients
template <typename T>
concept WebSocketClient =
    requires(T client, std::string_view text, std::span<const uint8_t> data) {
