...
//         ws::log::error("Invalid status line: Unable to find the HTTP
//         version"); return std::unexpected(Error::ParseError);
//     }
...
//         ws::log::error("Invalid status line: Unable to find the status
//         code"); return std::unexpected(Error::ParseError);
//     }
//     auto st = line.substr(sp1 + 1, sp2 - sp1 - 1);
//     if (((sp2 - sp1 - 1) != 3) || st < "100" || st > "599") {
//         ws::log::error("Invalid status line: Invalid status number '{}'",
//         st); return std::unexpected(Error::InvalidStatusCode);
//     }
...
//         }
//         // Extensions and protocol could technically be comma-separated, but
//         we
...
//     }
//     std::string_view header_view{reinterpret_cast<const char
//     *>(buffer.data()),
//                                  *actual_size};
